...
const Programming = () => {
  return (
    ...
    <button class="group flex items-center bg-transparent p-2 px-9 text-xl font-bold font-serif tracking-widest text-black">
        <span class="relative pb-1 text-black after:transition-transform after:duration-400 
